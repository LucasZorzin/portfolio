...
function WorksModal(props) {
    const { selectedProject } = useApiContext();
    const { showModal, setShowModal, language } = useApiContext();
                        ...
                        <div className='works-modal'>
                            <div className="row">
                                ...
                                <div className="col-12 col-md-6 description">
                                    ...
                                    <p className='tech-p'>
                                        <Typed
                                            strings={[selectedProject.tech]}
                                            typeSpeed={43}
                                        />
                                    </p>
                                    {selectedProject.githubUrl !== 'no' ?
